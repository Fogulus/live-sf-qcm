 ...
 */
final class Version20230518124732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE questionnaire (id INT AUTO_INCREMENT NOT NULL, matiere_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, INDEX IDX_7A64DAFF46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
